...
class PegawaiController extends Controller
{
    ...
    {
        // Nama
        $data['name'] = 'Triza Nabila Ariely';

        // Hitung umur dari tanggal lahir (pakai DateTime biasa)
        $birthdate = date_create('2006-03-25');
        $today = date_create(date('Y-m-d'));
        $age = date_diff($birthdate, $today)->y;
        $data['my_age'] = $age;

        // Hobi
        $data['hobbies'] = ['Olahraga', 'Membaca', 'Memasak', 'Berkebun', 'Travelling'];
        ...
        // Cita-cita
        $data['future_goal'] = 'Menjadi Software Engineer di perusahaan teknologi besar!';
